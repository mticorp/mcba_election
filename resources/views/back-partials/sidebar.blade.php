...
<aside class="main-sidebar elevation-4 sidebar-dark-danger">
    ...
    <p class="brand-link navbar-dark text-center">
        <img src="{{ url($election->company_logo) }}" alt="Company Logo" class="brand-image img-circle"
            style="opacity: 1"> <br>
        <span class="brand-text font-weight-light">{{ $election->company_name }}</span>
    </p>
    @endif
    ...
    <div class="sidebar mt-0">
        ...
        <nav>
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-compact" data-widget="treeview"
                ...
                <li
                    class="nav-item has-treeview {{ $request->segment(2) == 'logo' ? 'menu-open' : '' }} || {{ $request->segment(2) == 'favicon' ? 'menu-open' : '' }} || {{ $request->segment(2) == 'sms&reminder' ? 'menu-open' : '' }}">
                    <a href="#"
