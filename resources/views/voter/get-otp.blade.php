...
@section('content')
    ...
    <div class="modal fade" id="app_link" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer mx-auto">
                <a href="https://play.google.com/store/apps/details?id=com.mti.mmvote" class="btn btn-success"><i class="fas fa-download"></i> Get It Now</a>
    ...
    <!--IOS Modal -->
    <div class="modal fade" id="ios_app_link" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLongTitle"><img src="{{url('images/election_logo.png')}}" alt="Logo" width="10%"> mmVote</h5>            
            ...
            <div class="modal-footer mx-auto">
                <a href="https://apps.apple.com/ie/app/mmvote/id1573344215" class="btn btn-success"><i class="fas fa-download"></i> Get It Now</a>
                <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fas fa-times"></i> Close</button>            
            </div>
        </div>
        </div>
