        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Election Create</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
                ...
                <div class="card card-red card-outline">
                    ...
                    <div class="card-body">
                        <form method="post" id="election_form" class="form-horizontal">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input class="ques toggle-class" type="checkbox" id="ques"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="lucky toggle-class" type="checkbox" id="lucky" data-onstyle="success"
                                        data-offstyle="danger" data-toggle="toggle" data-on="ON" data-off="OFF">
                                    <hr>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" id="name"
                                            placeholder="Enter Election name..." value="{{ old('name') }}" autofocus>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="election_title_description" class="form-control" id="election_title_description"
                                            placeholder="Enter Election Title Description..." value="{{ old('election_title_description') }}" autofocus>
                                    </div>
                                </div>
                            </div>


                            <div class="candidate-information hidden">
                                <div class="row mb-3">
                                    <div class="col-12">
                                        <hr>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="textarea" name="candidate_title" id="candidate_title"
                                                placeholder="Place some text here"
                                                style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ old('candidate_title') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>

                            <div class="question-information hidden">
                                <div class="row mb-3">
                                    <div class="col-12">
                                        <hr>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <label for="ques_title">Question Title *</label>
                                         ...
                                         style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ old('ques_title') }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ old('ques_description') }}</textarea>
                            ...
                            <input type="hidden" name="lucky_flag" id="lucky_flag" value="0" />
                            <input type="hidden" name="ques_flag" id="ques_flag" value="0" />
                            <input type="hidden" name="candidate_flag" id="candidate_flag" value="0" />
                        </form>
                    </div>
                </div>
            </div>
...
<script>
    $(document).ready(function() {
            ...
            $("#election_form").on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ route('admin.election.store') }}",
                    method: "POST",
