                    ...
                    <div class="card card-red card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{route('generator.excel.export')}}" class="btn btn-success btn-flat"><i class="fa fa-download"></i> Download Excel</a>
                            </div>
                        </div>
                        <div class="card-body table-responsive">
                                    ...
                                    <form method="post" id="reminder" style="display: inline;">
                                        ...
                                        <div class="row mb-2">
                                          <div class="col-md-6">
                                                ...
                                                class="fa fa-bell" aria-hidden="true"></i> Send Reminder (All "Not
                                                Voted")</button>
                            ...
                            <table id="vidtable" class="table table-bordered datatable datatable-Client">
                                <thead>
                                    <tr>
                                        <th width="5%" class="text-center"> &nbsp; <input type="checkbox" name="checked_all" class=""></th>
                                        <th>NO</th>
                                        <th>Voter ID</th>
                                        <th>Name</th>
                                        <th>Email</th>
            ...
            <form id="sendMethod">
                  ...
                  <div class="col-md-4">
                    <div class="icheck-success d-inline">
                      ...
                      <label for="radioSuccess3">
                          <span class="label bg-primary"> Via Both <i class="fa fa-comment"></i> <i class="fa fa-envelope"></i></span>
                      </label>
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-12 text-center">
                  <button type="submit" class="btn btn-success btn-flat btn-sm"><i class="fa fa-paper-plane"></i> Send</button>
                  <button type="button" class="btn btn-danger btn-flat btn-sm" data-dismiss="modal"><i class="fa fa-reply-all"></i> Close</button>
                </div>
              </div>
            </form>
          </div>
