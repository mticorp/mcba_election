            ...
            <div class="col-md-8">
                <div class="card card-red card-outline">
                    <div class="card-header">
                        <h3 class="card-title">
                            {{ ($election->election_title_description != Null) ? "Updated Title Description" : " Add Title Description" }}
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.sms.descriptionupdate', ['id'=> $election->id]) }}" method="POST">
                            @csrf
                            @method('POST')
                            <div class="row justify-content-md-center">
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <textarea class="textarea" name="description" id="description"
                                            ...
                                            style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ old('description',$election->election_title_description) }}</textarea>
                                    </div>
                                            ...
                                            <div class="row mt-2">
                                                <div class="col-md-6">
                                                    ...
                                                    <button type="submit" class="btn btn-outline-primary btn-block"><i
                                                            ...
                                                            {{ ($election->election_title_description != Null) ?  "Updated Title Description" : " Add Title Description" }}</button>
