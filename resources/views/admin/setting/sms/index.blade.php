            ...
            <div class="col-md-8">
                <div class="card card-red card-outline">
                    <div class="card-header">
                        <h3 class="card-title">
                            {{ ($setting->sms_text == Null ) ? " Add SMS" : "Update SMS" }}
                        </h3>                        
                    </div>
                    <div class="card-body">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <textarea class="textarea" name="sms_text" id="sms_text"
                                            ...
                                            style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ old('sms_text',$setting->sms_text) }}</textarea>
                                    </div>
